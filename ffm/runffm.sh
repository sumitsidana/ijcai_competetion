./ffm-train -p /data/sidana/ijcai_competetion/baselines/ffm/test_val.csv.libffm -s 16 -l 0.001 -k 8 -r 0.2 -t 1000 --auto-stop /data/sidana/ijcai_competetion/baselines/ffm/train_val.csv.libffm  /data/sidana/ijcai_competetion/baselines/ffm/model
