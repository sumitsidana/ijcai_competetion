...
model = LightFM(no_components=4,loss='logistic',learning_rate=0.005, item_alpha=0.005, user_alpha=0.005)
...
export_basename = '/data/sidana/ijcai_competetion/data_analysis/baselines/vectors'
