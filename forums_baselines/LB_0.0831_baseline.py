...
if __name__ == "__main__":
    ...
    if online == False:
        ...
        train = data.copy()
        test = pd.read_csv('/Users/sumitsidana/ijcai_2018_competetion/ijcai_submissions/round1_ijcai_18_train_20180301.txt', sep=' ')
    ...
    if online == False:
        ...
        test[['instance_id', 'predicted_score']].to_csv('/Users/sumitsidana/ijcai_2018_competetion/ijcai_submissions/baseline_train.csv', index=False,sep=' ')