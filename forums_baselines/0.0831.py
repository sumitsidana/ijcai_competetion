...
if __name__ == "__main__":
    ...
    data = pd.read_csv('/Users/sumitsidana/ijcai_2018_competetion/ijcai_submissions/round1_ijcai_18_train_20180301.txt', sep=' ')
    ...
    if online == False:
        ...
        train = data.copy()
        test = pd.read_csv('/Users/sumitsidana/ijcai_2018_competetion/ijcai_submissions/round1_ijcai_18_test_a_20180301.txt', sep=' ')
    ...
    if online == False:
        ...
        test[['instance_id', 'predicted_score']].to_csv('/Users/sumitsidana/ijcai_2018_competetion/ijcai_submissions/baseline_0.0831.csv', index=False,sep=' ')#保存在线提交结果