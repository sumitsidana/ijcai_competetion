...
train, test = data.get_movielens_positive_data('/data/sidana/purch/diversity/baselines/interacted/'+sys.argv[1])
...
train_all, test_all = data.get_movielens_data('/data/sidana/purch/diversity/baselines/interacted/'+sys.argv[1])
...
export_basename = '/data/sidana/purch/diversity/baselines/interacted/'+sys.argv[1]+'/scores/vectors/'
